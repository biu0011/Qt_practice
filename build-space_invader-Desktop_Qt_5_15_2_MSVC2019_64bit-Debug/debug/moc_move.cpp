...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Move_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Move_t qt_meta_stringdata_Move = {
    {
QT_MOC_LITERAL(0, 0, 4) // "Move"
...
QT_INIT_METAOBJECT const QMetaObject Move::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Move.data,
    qt_meta_data_Move,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Move::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Move.stringdata0))
