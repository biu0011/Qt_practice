...
void Widget::drawWidget(QPainter &qp){
    ...
    int step = (int) qRound((double)width/DIVISION);
    int till = (int) ((width / MAX_CAPICITY)*cur_width);
    int full = (int)((width / MAX_CAPICITY)*FULL_CAPACITY);
    ...
    QColor grayColor = QColor(90,80,60);
    qp.setPen(grayColor);
